...
public sealed class EnrollmentServiceTests
{
    ...
    private sealed class FakeCurrentUser : ICurrentUser
    {
        ...
        public IReadOnlyCollection<string> Permissions => [PermissionConstants.Enrollments.View, PermissionConstants.Enrollments.Create, PermissionConstants.Enrollments.Delete];
    }

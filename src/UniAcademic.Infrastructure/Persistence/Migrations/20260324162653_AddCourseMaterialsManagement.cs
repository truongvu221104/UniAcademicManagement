...
{
    /// <inheritdoc />
    public partial class AddCourseMaterialsManagement : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseMaterials_FileMetadatas_FileMetadataId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseMaterials_CourseOfferingId_SortOrder",
                table: "CourseMaterials",
                columns: new[] { "CourseOfferingId", "SortOrder" });

            migrationBuilder.CreateIndex(
                name: "IX_CourseMaterials_FileMetadataId",
                table: "CourseMaterials",
                column: "FileMetadataId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FileMetadatas_RelativePath",
                table: "FileMetadatas",
                column: "RelativePath",
                unique: true);
        }
